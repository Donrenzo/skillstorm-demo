...
1 day lecture components and instructions:

![CodePipeline Diagram](https://github.com/skillstorm-congo/AWS-DevOps-StarterKit/blob/cf3e86bfca089bc67bc6e83e4c37a3820fab4ed3/Lecture%20Material/DevOps/CodePipeline-Demo/images/AWSCodePipelineDiagram.PNG)
-----------------------------------------------------------------------------------------------------------------------------------------
...
-----------------------------------------------------------------------------------------------------------------------------------------
**Update: Fixes issue with throttling from DockerHub**
- Create an ECR repo named python
- Run the following command in VScode:
```
docker pull python:3.8
```
- Run the push commands from the ECR repo
    - change the tags from latest to 3.8
- Change the Dockerfile in your flask app repo from "FROM python:3.8" to:
```
FROM public.ecr.aws/d9c7x7c8/python:3.8
```
...
![CodeBuild Phase Details](https://github.com/skillstorm-congo/AWS-DevOps-StarterKit/blob/cf3e86bfca089bc67bc6e83e4c37a3820fab4ed3/Lecture%20Material/DevOps/CodePipeline-Demo/images/CodeBuildPhaseDetailsCapture.PNG)
